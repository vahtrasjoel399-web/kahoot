...
Then move room state, answers, timers and leaderboard state out of the in-memory `Map` in `src/lib/game/room-engine.ts`. Supabase persists quizzes and completed results; Redis powers the active game.
